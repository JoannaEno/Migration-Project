...
@description('Optional. The name of the diagnostic setting, if deployed.')
param diagnosticSettingsNameAudit string = '${name}-diagnosticSettingsaudit'
...
// @description('The URI of the key vault.')
// output endpointconnection string = keyVault.properties.privateEndpointConnections[0].id
