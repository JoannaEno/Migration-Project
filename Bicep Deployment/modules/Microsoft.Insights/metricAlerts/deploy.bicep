...
param autoMitigate bool //changed
...
var odataType  = {'odata.type': any(alertCriteriaType)}
...
resource metricAlert 'Microsoft.Insights/metricAlerts@2018-03-01' = {
  ...
  properties: {
    ...
    criteria:  contains(alertCriteriaType, 'Microsoft.Azure.Monitor.WebtestLocationAvailabilityCriteria') ? union(odataType,criterias) : {
      'odata.type': any(alertCriteriaType)
      allOf: array(criterias)
    }
